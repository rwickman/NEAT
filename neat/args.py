...
def get_parser():
    ...
    parser.add_argument("--uniform_pop_distr", action="store_true",
        help="Split up the population uniformly across species.")

    parser.add_argument("--init_pop_size", type=int, default=150, 
        help="Initial population size.")
    parser.add_argument("--max_depth", type=int, default=-1, 
        help="Maximum depth of a network.")
    parser.add_argument("--max_nodes", type=int, default=-1, 
        help="Maximum number of nodes in the network.")
    ...
    parser.add_argument("--no_respeciate", action="store_true",
        help="Don't respeciate the population.")
